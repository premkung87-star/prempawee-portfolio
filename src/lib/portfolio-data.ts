  ...
  },
  {
    ...
    caseStudy: {
      ...
      screenshots: [
        ...
        {
          filename: "04-leads-conversations.webp",
          alt: {
            en: "Leads and conversations views side by side",
            th: "หน้า leads และ conversations แสดงคู่กัน",
          },
          caption: {
            en: "Latest 100 leads with full contact metadata + last 500 conversation rows grouped into ~30 sessions chronologically.",
            th: "100 leads ล่าสุด พร้อม metadata การติดต่อครบ + 500 rows ของ conversations ล่าสุด group เป็น ~30 sessions เรียงตามเวลา",
          },
          stubbed: true,
        },
      ],
